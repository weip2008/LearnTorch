...
class DataSource:
    config = Config(os.path.join(base_dir, 'src', 'config.ini'))
    log = Logger(os.path.join(base_dir, 'log', 'gru.log'), logger_name='data')
    conn = None
    ...
    def __init__(self):
        ...
        db_file = os.path.join(base_dir, '..', data_dir, sqliteDB)
