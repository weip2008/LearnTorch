...
file_train = 'data/SPX_TrainingData_30_160.csv' # 价格归一
file_test = 'data/SPX_TestingData_30_160.csv'
labels = ["long","short"]
total=54
columns = 1
window = 30
...
def getTrainingDataSet(file_path):
    ...
    inputs_tensor = torch.tensor(inputs).reshape(total,1,window)
