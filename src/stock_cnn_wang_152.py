...
file_train = 'data/SPX_TrainingData_120_152.csv'
file_test = 'data/SPX_TestingData_120_152.csv'
labels = ["long","short"]
total = 65
columns = 5
window = 120
...
class StockCNN(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(64 * (window*columns // 8), 128)  # Adjust size based on pooling
    ...
    def forward(self, x):
        ...
        x = x.view(-1, 64 * (window*columns // 8))  # Flatten the tensor for FC layers
