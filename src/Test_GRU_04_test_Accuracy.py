...
print(f'Test Low Data Loss (MSE): {test_low_loss:.4f}')
print(f'Test Low Data Accuracy: {test_low_accuracy:.4f}')
print(f'Test High Data Loss (MSE): {test_high_loss:.4f}')
print(f'Test High Data Accuracy: {test_high_accuracy:.4f}')
