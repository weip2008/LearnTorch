...
# Step 4: Create grouped dataloader
def create_grouped_dataloader(data, batch_size):
...
batch_size = 32
low_dataloader = create_grouped_dataloader(low_data, batch_size)
high_dataloader = create_grouped_dataloader(high_data, batch_size)
...
# Save the model
torch.save(model.state_dict(), 'timeseries_transformer_05_201.pth')
