    ...
    with open(file_path, 'r') as file:
        ...
        for row in reader:
            ...
            if prefix == [1, 0]:
                ...
                low_target.append(0)    #Long
                #low_target.append(prefix)    #Long
            elif prefix == [0, 1]:
                high_data.append(data_array)
                high_target.append(1)   #Short
                #high_target.append(prefix)   #Short
...
print(f'Low targets: {len(low_target)}')
print(f'High targets: {len(high_target)}')
...
save_path = 'GRU_training_results_505.pth'
...
for epoch in range(num_epochs):
    ...
    scheduler.step(avg_loss)  # Use the average loss to step the scheduler
